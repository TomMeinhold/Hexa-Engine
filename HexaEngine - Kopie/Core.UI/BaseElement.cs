        ...
        private void CalculateAbsolutePosition()
        {
            ...
            switch (HorizontalAlignment)
            {
                ...
                case HorizontalAlignment.Center:
                    AbsoluteCenteredPosition.X = Margin.Left + (Engine.RenderSystem.Form.Width / 2) - Margin.Right;
                    break;

                case HorizontalAlignment.Right:
                    AbsoluteCenteredPosition.X = Engine.RenderSystem.Form.Width - Margin.Right;
                    break;
            }
            ...
            switch (VerticalAlignment)
            {
                ...
                case VerticalAlignment.Center:
                    AbsoluteCenteredPosition.Y = Margin.Top + (Engine.RenderSystem.Form.Height / 2) - Margin.Bottom;
                    break;

                case VerticalAlignment.Bottom:
                    AbsoluteCenteredPosition.Y = Engine.RenderSystem.Form.Height - Margin.Bottom;
                    break;
            }
        }
