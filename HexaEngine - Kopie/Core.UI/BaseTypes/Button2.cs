...
{
    public class Button2 : UIElement
    {
        ...
        {
            textLayout = Engine.RenderSystem.DirectWrite.GetTextLayout(Content, Engine.RenderSystem.DirectWrite.DefaultTextFormat, float.MaxValue);
        }
