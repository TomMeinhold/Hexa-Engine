...
namespace HexaEngine.Core
{
    ...
    public class BitmapConverter
    {
        ...
        {
            return Common.ConvertBitmap.Convert(Engine.RenderSystem.DriectXManager.D2DDeviceContext, bitmap, alhpa);
        }

        public Texture2D ConvertBitmap(System.Drawing.Bitmap bitmap)
        {
            return Common.ConvertBitmap.Convert(Engine.RenderSystem.DriectXManager.D3DDeviceContext, bitmap);
        }
    }
}