    ...
    public partial class PhysicsEngine : IDisposable
    {
        ...
        private void ThreadVoid()
        {
            ...
            while (!IsDisposing)
            {
                ...
                if (Engine.SceneManager.SelectedScene != null)
                {
                    lock (Engine.SceneManager.SelectedScene.Objects)
                    {
                        physicsObjects = GetOnlyIPhysicsObject(Engine.SceneManager.SelectedScene.Objects).ToList();
                    }
