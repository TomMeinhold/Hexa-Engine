...
using HexaEngine.Core.Windows.Interop;
using System;
...
namespace HexaEngine.Core.Windows
{
    public abstract partial class Application : IDisposable
    {
        ...
        private RenderPlatform _graphicsDevice;
        ...
        {
            _graphicsDevice = new RenderPlatform(MainWindow);
        }

        public static readonly string WndClassName = "HexaEngineWindow";
        ...
        private void PlatformConstruct()
        {
            ...
            // Create main window.
            MainWindow = new Window("HexaEngine", 1280, 720);
        }
